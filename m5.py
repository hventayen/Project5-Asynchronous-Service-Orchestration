...
async def start_new_game(username: str, game_id: int):
    # TODO:
        ...
        # Plan of action:
            ...
            # Create the actual game:
                # Microservice 4: @app.post('/game/{game_id}')
    ...
    # ret = httpx.get('http://127.0.0.1:5400/words/apple')
    # return ret.text
...
async def guess_a_word(game_id: int, user_id: int, guess: str):
    # TODO:
        ...
        # Verify the guess is a word in dictionary
            # Microservice 1: @app.get("/words/{letters}")
        ...
        # Check to see if the guess is correct
            # Microservice 2: @app.get("/games/{answer_id}")
